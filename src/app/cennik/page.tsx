            ...
            <div className='description mb-10 flex flex-col lg:flex-row gap-8'>
              <div className='text-lg w-full lg:w-5/12 xl:w-4/12'>
                ...
                <strong>
                  ...
                  zawartość na jednej długiej stronie, zamiast podzielać treści
                  na kilka róznych podstron
                </strong>
                .
              </div>
              <div className='w-full lg:w-7/12 xl:w-8/12'>
                ...
                <p>
                  <strong>
                    ...
                    użytkownikowi. Pozwalają na kreatywne podejście do
                    prezentacji treści i skoncentrowanie się na ważnych
          ...
          <li>
            ...
            <div className='description mb-10 flex flex-col lg:flex-row gap-8'>
              <div className='text-lg w-full lg:w-5/12 xl:w-6/12'>
                Landing page (strona docelowa) to pojedyncza strona internetowa,
                na którą użytkownik trafia po kliknięciu w link z zewnętrznego
                źródła, takiego jak reklama, newsletter, czy wynik wyszukiwania.
                <strong>
                  Celem landing page jest przyciągnięcie uwagi użytkownika i
                  zachęcenie go do podjęcia określonej akcji, takiej jak zakup,
                  rejestracja, pobranie pliku, wypełnienie formularza itp.
                </strong>
              </div>
              <div className='w-full lg:w-7/12 xl:w-6/12'>
                <p className='pb-6'>
                  ...
                  odwiedzających na klientów lub aktywnych użytkowników. Dzięki
                  odpowiedniemu projektowaniu i optymalizacji, landing page może
                  skutecznie zwiększyć współczynnik konwersji i efektywność
      ...
      <section className='container pb-20 pt-20'>
        <ul>
          <li>
            ...
            <div className='description mb-10 flex flex-col lg:flex-row gap-8'>
              <div className='text-lg w-full lg:w-5/12 xl:w-6/12'>
                Strona oparta o WordPress to witryna internetowa zbudowana przy
                użyciu systemu zarządzania treścią (CMS) o nazwie WordPress.
                <strong>
              ...
              <div className='w-full lg:w-7/12 xl:w-6/12'>
                <p className='pb-6'>
                  ...
                  Dzięki prostocie obsługi i szerokim możliwościom dostosowania,
                  WordPress jest popularnym wyborem dla osób i firm chcących
                  stworzyć funkcjonalną i atrakcyjną witrynę internetową.
                </p>
              </div>
            </div>
            <p>
            ...
            <ul className='list-disc pt-5 pl-5'>
              <li>
                Przygotowanie dedykowanego projektu graficznego lub modyfikacja
                gotowego motywu pod określone wymagania klienta ( strona głównia
                + do 5 podstron)
              </li>
              <li>Przygotowanie dedykowanej strony typu 404</li>
              <li>
                Przygotowanie stron z wpisami, szablon strony podejyńczego wpisu
              </li>
            ...
            <div className='description mb-10 flex flex-col lg:flex-row gap-8'>
              ...
              <div className='w-full lg:w-7/12 xl:w-6/12'>
                <p className='pb-6'>
                  ...
                  klienta oraz uzupełnienia wybranego motywu treścią dostarczoną
                  od klienta.
                </p>
                <p>
